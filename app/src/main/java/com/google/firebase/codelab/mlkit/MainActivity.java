...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] items = new String[]{"Test Image 1 (Text)", "Test Image 2 (Text)", "Test Image 3" +
                " (Face)", "Test Image 4 (Object)", "Test Image 5 (Object)", "Test Image 6 (Text)","Test Image 7 (Text)",
                "Test Image 8 (Text)","Test Image 9 (Text)"};
    ...
    private void processTextRecognitionResult(FirebaseVisionText texts) {
        ...
        for (int i = 0; i < blocks.size(); i++) {
            ...
            for (int j = 0; j < lines.size(); j++) {
                Log.d("Firebase Scanner",lines.get(j).getText());
    ...
    public void onItemSelected(AdapterView<?> parent, View v, int position, long id) {
        ...
        switch (position) {
            ...
            case 4:
                ...
                break;
            case 5:
                mSelectedImage = getBitmapFromAsset(this, "cardImage1.jpg");
                break;
            case 6:
                mSelectedImage = getBitmapFromAsset(this, "cardImage2.jpg");
                break;
            case 7:
                mSelectedImage = getBitmapFromAsset(this, "cardImage3.jpg");
                break;
            case 8:
                mSelectedImage = getBitmapFromAsset(this, "cardImage4.jpg");
                break;
        }
